...
// 1. psac_sale
addColumnIfNotExists($pdo, 'psac_sale', 'total_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'net_wt');
addColumnIfNotExists($pdo, 'psac_sale', 'total_gross_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'total_wt');
addColumnIfNotExists($pdo, 'psac_sale', 'sms_sent', 'VARCHAR(50) DEFAULT "No"', 'status');

// 2. psac_production
addColumnIfNotExists($pdo, 'psac_production', 'forfeiture_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'point_wt');
addColumnIfNotExists($pdo, 'psac_production', 'forfeiture_rt_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'forfeiture_wt');
addColumnIfNotExists($pdo, 'psac_production', 'total_pt_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'forfeiture_rt_wt');
addColumnIfNotExists($pdo, 'psac_production', 'jhinga_point_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'total_wt');
addColumnIfNotExists($pdo, 'psac_production', 'jhinga_depot_wt', 'DECIMAL(12,2) DEFAULT 0.00', 'jhinga_point_wt');

// 3. psac_product_dispatch
$pdo->exec("ALTER TABLE `psac_product_dispatch` MODIFY COLUMN `status` VARCHAR(50) DEFAULT 'Active'");
addColumnIfNotExists($pdo, 'psac_product_dispatch', 'total_box', 'INT(11) DEFAULT 0', 'dispatch_to');
addColumnIfNotExists($pdo, 'psac_product_dispatch', 'departure_time', 'DATETIME NULL', 'total_box_wt');
addColumnIfNotExists($pdo, 'psac_product_dispatch', 'arrival_time', 'DATETIME NULL', 'departure_time');

// 4. psac_cash_received
addColumnIfNotExists($pdo, 'psac_cash_received', 'amount', 'DECIMAL(12,2) DEFAULT 0.00', 'client_id');
addColumnIfNotExists($pdo, 'psac_cash_received', 'invoice_number', 'VARCHAR(50) NULL', 'client_id');
addColumnIfNotExists($pdo, 'psac_cash_received', 'remition_by', 'VARCHAR(100) DEFAULT "Bank"', 'amount');
addColumnIfNotExists($pdo, 'psac_cash_received', 'updated_by', 'INT(11) NULL', 'added_date');
addColumnIfNotExists($pdo, 'psac_cash_received', 'updated_date', 'DATETIME NULL', 'updated_by');
addColumnIfNotExists($pdo, 'psac_cash_received', 'action_microtime', 'VARCHAR(50) NULL', 'updated_date');
addColumnIfNotExists($pdo, 'psac_cash_received', 'source', 'VARCHAR(50) DEFAULT "Web"', 'action_microtime');

echo "\nSeeding data...\n";

// Seed psac_sale
$pdo->exec("TRUNCATE TABLE psac_sale");
$pdo->exec("
...
// Seed psac_production
$pdo->exec("TRUNCATE TABLE psac_production");
$pdo->exec("
...
// Seed psac_product_dispatch
$pdo->exec("TRUNCATE TABLE psac_product_dispatch");
$pdo->exec("
...
// Seed psac_cash_received
$pdo->exec("TRUNCATE TABLE psac_cash_received");
$pdo->exec("
...
// Seed psac_free_sale
$pdo->exec("TRUNCATE TABLE psac_free_sale");
$pdo->exec("
...
echo "All schema fixes and data seeding complete successfully!\n";
