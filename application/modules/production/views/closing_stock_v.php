    ...
    <div class="panel panel-white" id="report_panel">
        <div class="panel-heading border-light light-bg">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <button type="button" class="btn btn-info print_data" data-target="#<?=$table_class?>"> <i class="fa fa-print"></i> Print</button>
                    <button type="button" class="btn btn-success save_closing_stock" data-target="#<?=$table_class?>"> <i class="fa fa-print"></i> Save Closing Stock</button>
                </div>
                <div class="col-md-2">
		...
		<div class="panel-body">
        	<div class="table-responsive">
                <div class="row" id="<?=$table_class?>" style="width:1700px;">
                    <div class="col-sm-12">
                    <table class="table report_table_header">
                        ...
                        <tbody>
                        	<tr>
                            	<td colspan="30">
                                	<div class="panel-scroll height-300" style="width:1700px;">
