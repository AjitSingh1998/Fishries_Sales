...
<!-- start: GOOGLE FONTS -->
<link href="<?php echo base_url()?>assets/css/google-font.css?family=Lato:300,400,400italic,600,700|Raleway:300,400,500,600,700|Crete+Round:400italic" rel="stylesheet" type="text/css" />
<!-- end: GOOGLE FONTS -->
<!-- start: MAIN CSS -->
