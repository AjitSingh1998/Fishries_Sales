...
<div class="panel-body">
  <div class="container">
  	<?php 
		$attributes = array( 'class'=>'form-vertical common-css add_package','id'=>'add_package','role'=>'form' , 'enctype'=>'multipart/form-data' );
		echo form_open('settings/business/add_package', $attributes )?>        
        <div class="row">
          <div class="col-sm-4">
            <h4> Staff details </h4>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <label class="staff_group"> Select Package Course </label>
                  <select class="form-control" name="staff_group">
                  	<option value=""> Select Group </option>
                    <?php 
						if(!empty($staff_group)){ 
							foreach($staff_group as $group){
