...
<div class="form-group">
  <label class="col-sm-3 control-label"> Product Rate <span class="symbol required"></span> </label>
  <div class="col-sm-8">
    <input type="text" placeholder="Product Rate" class="form-control" name="rate" value="<?=set_value('rate', $Rate)?>">
  </div>
</div>
<div class="form-group">
  <label class="col-sm-3 control-label">Old Stock </label>
  <div class="col-sm-8">
    <input type="text" placeholder="Old Stock" class="form-control" name="Stock" value="<?=set_value('Stock', $Stock)?>">
  </div>
</div>
<div class="form-group">
