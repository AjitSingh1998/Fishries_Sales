                ...
                <div class="col-md-12">
                    ...
                    <div class="tabbable tabs-left">
                        <ul id="myTab3" class="nav nav-tabs tab-bricky">
							...
							?>
                            <li<?=$active?>>
                                <a href="<?=site_url('setup/administration/permission/'.$group['group_id'])?>"><?php echo $group['group_name']?></a>
                            </li>
                            <?php }}?>           
                        </ul>
                            ...
                            <div class="tab-pane active">
								<?php 
                                    if(in_array('edit', $actions)){
                                        echo form_open(site_url('setup/administration/permission/'.$group_id)); 
                                ?>
