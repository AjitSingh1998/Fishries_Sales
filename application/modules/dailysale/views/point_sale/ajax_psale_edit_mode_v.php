...
<!-- start: BREADCRUMB -->
  ...
  <?php echo form_open('', 'class="form-horizontal point_sale_form" id="point_sale_form"');?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 for_new">
      ...
      <div class="editable-input">
        <input type="text" name="customer_code" readonly="readonly" class="form-control input-sm customer disabled" id="customer_code" value="<?=$sale_data['client_id']?>" />
    ...
    <div class="col-sm-2 for_new">
      ...
      <div class="editable-input">
        <input type="text" name="customer_name" readonly="readonly" class="form-control input-sm customer disabled" id="customer_name" maxlength="50" value="<?=$sale_data['client_name']?>" />
        <span class="edit-icon change_customer"><i class="fa fa-pencil"></i></span>
      </div>
    </div>
    <div class="col-sm-2 for_new">
      ...
      <div class="editable-input">
        <input type="text" name="customer_mobile" readonly="readonly" class="form-control input-sm strict_integer customer disabled" id="customer_mobile" maxlength="30" value="<?=$sale_data['client_mobile']?>" />
        <span class="edit-icon change_customer"><i class="fa fa-pencil"></i></span>
      </div>
    </div>
    <div class="col-sm-3 for_new">
      ...
      <div class="editable-input">
        <input type="text" class="form-control input-sm disabled" readonly="readonly" name="customer_email" id="customer_email" value="<?=$sale_data['client_email']?>" />
        <span class="edit-icon change_customer"><i class="fa fa-pencil"></i></span>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-8">
        ...
        <textarea name="remark" class="form-control"><?=$sale_data['sale_remark']?></textarea>
    </div>
    <div class="col-sm-3" style="margin-top: 15px"> <br />
      <button type="button" class="btn btn-success save_point_sale_data">Update</button>&nbsp;
      <a href="<?=site_url('dailysale/point/edit/'.$sale_id)?>" class="btn btn-danger">Cancel</a>
    </div>
  </div>
  <?php echo form_close();?>
