...
(211, 211, 'Role Permissions', 2, 'Active', 'setup/administration/permission', 1, 'Role Permissions', '', 11, 'Unlock'),
(212, 212, 'Menu Management', 2, 'Active', 'setup/administration/menu_items', 1, 'Menu Management', '', 12, 'Unlock'),
(213, 213, 'System Settings', 2, 'Active', 'setup/administration/settings', 1, 'System Settings', '', 13, 'Unlock'),
(214, 214, 'Company Details', 2, 'Active', 'setup/administration/company_details', 1, 'Company Details', '', 14, 'Unlock'),
...
-- 7. Data Tools (Import & Sync)
(7, 7, 'Data Tools', 0, 'Active', 'excel_import/excel_import/production', 0, 'Data Tools', 'fa fa-exchange', 7, 'Unlock'),
(701, 701, 'Import Production', 7, 'Active', 'excel_import/excel_import/production', 1, 'Import Production', '', 1, 'Unlock'),
(702, 702, 'Import Dispatch Boxes', 7, 'Active', 'excel_import/excel_import/dispatch_box', 1, 'Import Dispatch Boxes', '', 2, 'Unlock'),
(703, 703, 'Sync Local Data', 7, 'Active', 'sync_data/sync_data/local', 1, 'Sync Local Data', '', 3, 'Unlock'),
(704, 704, 'Sync Live Data', 7, 'Active', 'sync_data/sync_data/live', 1, 'Sync Live Data', '', 4, 'Unlock'),

-- 8. Database
(8, 8, 'Database', 0, 'Active', 'database/database/setting', 0, 'Database', 'fa fa-database', 8, 'Unlock'),
(801, 801, 'Database Setting', 8, 'Active', 'database/database/setting', 1, 'Database Setting', '', 1, 'Unlock'),
(802, 802, 'Backup Database', 8, 'Active', 'database/database/start_backup', 1, 'Backup Database', '', 2, 'Unlock'),
(803, 803, 'Yearly Backup', 8, 'Active', 'database/yearly_backup/add_newdb', 1, 'Yearly Backup', '', 3, 'Unlock');

-- Clean and Populate psac_administrator_group_permission for all groups
TRUNCATE TABLE psac_administrator_group_permission;

-- Grant all permissions for Super Admin (group_id = 1) and all other groups
INSERT INTO psac_administrator_group_permission (`group_id`, `menu_id`, `actions`, `editable`)
SELECT g.id AS group_id, m.page_menu_id AS menu_id, '["add","edit","delete","view","export","import","print","lock"]' AS actions, 'Unlock' AS editable
