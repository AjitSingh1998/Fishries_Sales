...
$(document).ready(function() {
	...
	$('a.add_break_hour').click(function(){
		...
		$cloned.find('.'+day_name+'_fh').attr('name',day_name+'[break][from_hours][]');
		...
		break_input.append('<input type="text" placeholder="Break Name" name="'+day_name+'[break][name][]" class="form-control" />');
